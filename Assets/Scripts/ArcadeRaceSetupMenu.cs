...
public sealed class ArcadeRaceSetupMenu : MonoBehaviour
{
    ...
    private void BuildMenu()
    {
        ...
        CreateText("Laps Label", panelObject.transform, "Laps", 30, TextAnchor.MiddleLeft, new Vector2(0.5f, 1f), new Vector2(-250f, -190f), new Vector2(180f, 52f));
        CreateButton("Laps Minus", panelObject.transform, "-", 34, new Vector2(0.5f, 1f), new Vector2(50f, -190f), new Vector2(68f, 52f), DecreaseLaps);
        lapsValueText = CreateText("Laps Value", panelObject.transform, selectedLaps.ToString(), 32, TextAnchor.MiddleCenter, new Vector2(0.5f, 1f), new Vector2(132f, -190f), new Vector2(92f, 52f));
        CreateButton("Laps Plus", panelObject.transform, "+", 34, new Vector2(0.5f, 1f), new Vector2(230f, -190f), new Vector2(68f, 52f), IncreaseLaps);

        CreateText("Difficulty Label", panelObject.transform, "Difficulty", 30, TextAnchor.MiddleLeft, new Vector2(0.5f, 1f), new Vector2(-250f, -280f), new Vector2(220f, 52f));
        difficultyValueText = CreateText("Difficulty Value", panelObject.transform, selectedDifficulty.ToString(), 28, TextAnchor.MiddleRight, new Vector2(0.5f, 1f), new Vector2(60f, -280f), new Vector2(260f, 52f));
        ...
        for (int i = 0; i < difficulties.Length; i++)
        {
            ...
            Vector2 position = new Vector2(startX + i * 152f, -360f);
        ...
        CreateButton("Start Race", panelObject.transform, "Start Race", 34, new Vector2(0.5f, 0f), new Vector2(0f, 76f), new Vector2(360f, 72f), StartRace);
    }
    ...
    private void StartRace()
    {
        ...
        raceManager.SetRaceSetup(selectedLaps, selectedDifficulty);
